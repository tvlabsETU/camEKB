...
add wave -position end sim:/tb_pal/EKB_top_0/image_sensor_RX_LVDS_q/RX_DDR_CH_q0/data_rx_ch_0
add wave -position end sim:/tb_pal/EKB_top_0/image_sensor_RX_LVDS_q/RX_DDR_CH_q1/data_rx_ch_1
add wave -position end  sim:/tb_pal/EKB_top_0/image_sensor_RX_LVDS_q/RX_DDR_CH_q2/data_rx_ch_2
add wave -position end  sim:/tb_pal/EKB_top_0/image_sensor_RX_LVDS_q/RX_DDR_CH_q3/data_rx_ch_3
add wave -position end  sim:/tb_pal/EKB_top_0/image_sensor_RX_LVDS_q/RX_DDR_CH_q3/align_load_0
add wave -position end  sim:/tb_pal/EKB_top_0/image_sensor_RX_LVDS_q/mux_ch_to_raw_q/ram_raddr_q/ram_raddr
add wave -position end  sim:/tb_pal/EKB_top_0/image_sensor_RX_LVDS_q/mux_ch_to_raw_q/ram_waddr_q/ram_waddr
add wave -position end  sim:/tb_pal/EKB_top_0/image_sensor_RX_LVDS_q/mux_ch_to_raw_q/valid_data_rx
