...
architecture DEF_ARCH of PLL_SIM_IS_1 is 
...
begin 
    ...
    Core : PLL
      generic map(VCOFREQUENCY => 206.250)

      port map(CLKA => CLKAP, EXTFB => \GND\, POWERDOWN => 
        POWERDOWN, GLA => GLA, LOCK => LOCK, GLB => GLB, YB => 
        OPEN, GLC => GLC, YC => OPEN, OADIV0 => \GND\, OADIV1 => 
        \GND\, OADIV2 => \GND\, OADIV3 => \GND\, OADIV4 => \GND\, 
        OAMUX0 => \GND\, OAMUX1 => \GND\, OAMUX2 => \VCC\, 
        ...
        \VCC\, DLYYB0 => \GND\, DLYYB1 => \GND\, DLYYB2 => \GND\, 
        ...
        OCDIV2 => \GND\, OCDIV3 => \GND\, OCDIV4 => \GND\, OCMUX0
         => \VCC\, OCMUX1 => \GND\, OCMUX2 => \VCC\, DLYYC0 => 
...
-- MGNTIMER:F
-- MGNCMPL:T
-- DESDIR:G:/ACTELL/EKB/EKB/Libero/smartgen\PLL_SIM_IS_1
-- GEN_BEHV_MODULE:F
